CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_source] (
    ...
    CONSTRAINT [FK_857e1cee10c832cdd99e84b5e68] FOREIGN KEY ([visualId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[visual] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_source_visualId]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_source]([visualId] ASC);


GO

CREATE NONCLUSTERED INDEX [idx_ib_source_workloadItemId]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_source]([workloadItemId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_source_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_source]([recordGuid] ASC);
