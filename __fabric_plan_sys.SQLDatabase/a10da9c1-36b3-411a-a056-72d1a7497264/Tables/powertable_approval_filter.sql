CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval_filter] (
    ...
    CONSTRAINT [FK_94539a8181a5a4dc2ea1ea42a12] FOREIGN KEY ([approvalId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_filter_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval_filter]([recordGuid] ASC);
