CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[writeback] (
    ...
    CONSTRAINT [FK_bbc1ed3d35bb48f8c0823c361c0] FOREIGN KEY ([visualId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[visual] ([id])
);
