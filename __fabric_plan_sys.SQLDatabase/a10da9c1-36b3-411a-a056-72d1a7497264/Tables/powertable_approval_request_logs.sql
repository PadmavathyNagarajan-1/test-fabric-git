CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval_request_logs] (
    ...
    CONSTRAINT [FK_f93b73db3abf98a99f7f3ed6092] FOREIGN KEY ([approvalRequestId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval_request] ([id])
);
