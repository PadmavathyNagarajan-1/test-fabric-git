CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval_level] (
    ...
    CONSTRAINT [FK_c83f41d1a622e4368ad562c3310] FOREIGN KEY ([approvalId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_level_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval_level]([recordGuid] ASC);
