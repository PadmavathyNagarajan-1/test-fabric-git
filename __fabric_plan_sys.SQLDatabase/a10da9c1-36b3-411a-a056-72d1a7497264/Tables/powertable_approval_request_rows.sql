CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval_request_rows] (
    ...
    CONSTRAINT [FK_a782d5b8982a5f441a565c1fa12] FOREIGN KEY ([approvalRequestId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval_request] ([id])
);
