CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source_settings] (
    ...
    CONSTRAINT [FK_aca67c695d159618d8bcdbc163f] FOREIGN KEY ([sourceId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_source_settings_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source_settings]([recordGuid] ASC);
