CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_column_config] (
    ...
    CONSTRAINT [FK_861df9ce80f8cd19e53d376dbcb] FOREIGN KEY ([sourceId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_column_config_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_column_config]([recordGuid] ASC);
