CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_automation] (
    ...
    CONSTRAINT [FK_84f71feccc1ee888ab03a46330c] FOREIGN KEY ([sourceId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_automation_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_automation]([recordGuid] ASC);
