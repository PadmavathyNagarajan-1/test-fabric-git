CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_comment] (
    ...
    CONSTRAINT [FK_e923d030022f35af27a650126af] FOREIGN KEY ([sourceId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source] ([id])
);
