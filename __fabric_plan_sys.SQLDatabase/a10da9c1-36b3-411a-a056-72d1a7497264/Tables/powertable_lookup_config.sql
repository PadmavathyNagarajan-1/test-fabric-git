CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_lookup_config] (
    ...
    CONSTRAINT [FK_44ada73e90ba9eb593ec9ae3d0c] FOREIGN KEY ([sourceId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_lookup_config_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_lookup_config]([recordGuid] ASC);
