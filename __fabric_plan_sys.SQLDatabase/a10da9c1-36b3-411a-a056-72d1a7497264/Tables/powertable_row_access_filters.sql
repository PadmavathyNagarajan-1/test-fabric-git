CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_row_access_filters] (
    ...
    CONSTRAINT [FK_4cf5fc924af7310bf47527e6997] FOREIGN KEY ([sourceSettingsId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source_settings] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_row_access_filters_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_row_access_filters]([recordGuid] ASC);
