CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_transformation_steps] (
    ...
    CONSTRAINT [FK_8a9b406684b6d9fc5b0e6a20189] FOREIGN KEY ([queryId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_transformation_steps_queryId]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_transformation_steps]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_transformation_steps_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_transformation_steps]([recordGuid] ASC);
