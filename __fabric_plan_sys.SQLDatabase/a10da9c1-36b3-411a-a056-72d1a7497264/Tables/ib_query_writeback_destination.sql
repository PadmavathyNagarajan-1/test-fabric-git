CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_writeback_destination] (
    ...
    CONSTRAINT [FK_7534fdf394126d74de811d59cd7] FOREIGN KEY ([queryId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_destination_queryId]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_writeback_destination]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_destination_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_writeback_destination]([recordGuid] ASC);
