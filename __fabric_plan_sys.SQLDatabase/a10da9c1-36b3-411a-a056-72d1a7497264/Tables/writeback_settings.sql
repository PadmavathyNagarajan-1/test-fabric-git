CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[writeback_settings] (
    ...
    CONSTRAINT [FK_94e8f3168953c07cd61ff067f34] FOREIGN KEY ([visualId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[visual] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_writeback_settings_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[writeback_settings]([recordGuid] ASC);
