CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[comment] (
    ...
    CONSTRAINT [FK_c17116b9b990ba6990fd8b139b7] FOREIGN KEY ([visualId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[visual] ([id]) ON DELETE CASCADE
);
