CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval] (
    ...
    CONSTRAINT [FK_4dc3ff09cd30268621a118617d8] FOREIGN KEY ([sourceId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_source] ([id])
);
...
CREATE UNIQUE NONCLUSTERED INDEX [UQ_powertable_approval_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[powertable_approval]([recordGuid] ASC);
