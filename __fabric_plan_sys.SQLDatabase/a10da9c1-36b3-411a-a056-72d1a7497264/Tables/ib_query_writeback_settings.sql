CREATE TABLE [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_writeback_settings] (
    ...
    CONSTRAINT [FK_8bcb8471b229716279935805b96] FOREIGN KEY ([queryId]) REFERENCES [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_queries] ([id]) ON DELETE CASCADE
);
...
CREATE NONCLUSTERED INDEX [idx_ib_query_writeback_settings_queryId]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_writeback_settings]([queryId] ASC);


GO

CREATE UNIQUE NONCLUSTERED INDEX [UQ_ib_query_writeback_settings_recordGuid]
    ON [a10da9c1-36b3-411a-a056-72d1a7497264].[ib_query_writeback_settings]([recordGuid] ASC);
